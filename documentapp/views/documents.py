...
from documentapp.serializers import (
    DocumentCreateSerializer,
    DocumentListSerializer,
    DocumentVerifySerializer,
)
from documentapp.services.pdf_service import generate_document_pdf
                ...
                if '<html' not in content_html.lower():
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .ck-content {{ font-size: 14px; position: relative; }}
                    ...
                    <body>
                        ...
                        <div class="footer">
                            Verification: {document.tracking_field}
                        </div>
                    </body>
                    </html>
                    """
